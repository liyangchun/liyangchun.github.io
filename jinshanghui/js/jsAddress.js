...
var addressInit = function(_cmbProvince, _cmbCity, _cmbArea, defaultProvince, defaultCity, defaultArea,_selProvince,_selCity,_selArea)
{
	var cmbProvince = document.getElementById(_cmbProvince);
	var cmbCity = document.getElementById(_cmbCity);
	var cmbArea = document.getElementById(_cmbArea);

	var selProvince = document.getElementById(_selProvince);
	var selCity = document.getElementById(_selCity);
	var selArea = document.getElementById(_selArea);
	...
	function changeArea(){
		...
		selArea.value=cmbArea.options[cmbArea.selectedIndex].value;
		}
